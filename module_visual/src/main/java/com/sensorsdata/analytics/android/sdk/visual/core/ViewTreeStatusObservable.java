...
package com.sensorsdata.analytics.android.sdk.visual.core;
    ...
    private ViewNode getSingleViewPathAndPosition(View clickView, boolean fromVisual) {
        ...
        if (parent_view == null) {
            ...
            if (currentNode != null) {
                 ...
                 * 增加类型、isListView格式调试
                 */
                //currentNode = new ViewNode(clickView, currentNode.getViewPosition(), opx.toString(), px.toString(), currentNode.getViewContent(), currentNode.getViewType(), currentNode.isListView());
            }
        }
        return currentNode;
    }
