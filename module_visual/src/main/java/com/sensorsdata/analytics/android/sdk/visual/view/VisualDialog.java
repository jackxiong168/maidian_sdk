...
import com.sensorsdata.analytics.android.sdk.visual.http.NetWrapper;
    ...
    public static void showOpenVisualizedAutoTrackDialog(final Activity context,
        ...
        builder.setNegativeButton(SADisplayUtil.getStringResource(context,
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                SensorsDataDialogUtils.startLaunchActivity(context);
                //NetWrapper.getInstance().disconnect();
            }
        });
        builder.setPositiveButton(SADisplayUtil.getStringResource(context,
                com.sensorsdata.analytics.android.sdk.R.string.sensors_analytics_common_continue)
            ...
            public void onClick(DialogInterface dialog, int which) {
                VisualizedAutoTrackService.getInstance().stop();
                NetWrapper.getInstance().get(context,featureCode,postUrl);
            }
        });
        AlertDialog dialog = builder.create();
        SensorsDataDialogUtils.dialogShowDismissOld(dialog);
