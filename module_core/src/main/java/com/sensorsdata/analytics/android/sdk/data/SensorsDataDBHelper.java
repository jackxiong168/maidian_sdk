...
class SensorsDataDBHelper extends SQLiteOpenHelper {
    ...
    private static final String CREATE_VISUAL_CONFIGS_TABLE =
            String.format("CREATE TABLE %s (_id INTEGER PRIMARY KEY AUTOINCREMENT, %s TEXT NOT NULL" +
                            ", %s TEXT, %s TEXT NOT NULL, %s TEXT NOT NULL, %s TEXT);",
                    DbParams.TABLE_VISUAL_CONFIGS, DbParams.KEY_SCREEN_NAME,
                    DbParams.KEY_ELEMENT_SELECTOR,DbParams.KEY_EVENT_ID,
                    DbParams.KEY_EVENT_TYPE,DbParams.KEY_ELEMENT_POSITION);
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL(CREATE_VISUAL_CONFIGS_TABLE);
    }
