...
public class PersistentLoader {
    ...
    private final PersistentVisualConfigsMD5 mVisualConfigsMD5;
    ...
    private PersistentLoader(Context context) {
        ...
        mVisualConfigsMD5 = (PersistentVisualConfigsMD5) loadPersistent(DbParams.PersistentName.VISUAL_CONFIGS_SIGN);
    ...
    private PersistentIdentity<?> loadPersistent(String persistentKey) {
        ...
        switch (persistentKey) {
            ...
            case DbParams.PersistentName.VISUAL_CONFIGS_SIGN:
                return new PersistentVisualConfigsMD5();
            default:
                return null;
        }
    }
    ...
    public PersistentVisualConfigsMD5 getVisualConfigsMD5() {
        return mVisualConfigsMD5;
    }
}
