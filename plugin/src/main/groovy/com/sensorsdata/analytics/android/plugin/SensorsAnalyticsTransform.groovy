...
class SensorsAnalyticsTransform extends Transform {
    ...
    @Override
    String getName() {
        return "onebuygzAnalyticsAutoTrack"
    }
    ...
    //todo 加载项目中的所有class文件路径保存在URLClassLoader中
    ...
    private void checkSensorsSDK() {
        try {
            ...
            //类class文件所在的目录/D:/xwj_project/onebuy_gz/maidian_sdk/module_core/build/intermediates/runtime_library_classes_jar/debug/classes.jar
    ...
    void forEachDirectory(boolean isIncremental, DirectoryInput directoryInput, TransformOutputProvider outputProvider, Context context) {
        ...
        //D:\xwj_project\onebuy_gz\maidian_sdk\demo\build\intermediates\javac\debug\classes
        String srcDirPath = dir.absolutePath
        //D:\xwj_project\onebuy_gz\maidian_sdk\demo\build\intermediates\transforms\sensorsAnalyticsAutoTrack-local\debug\59
