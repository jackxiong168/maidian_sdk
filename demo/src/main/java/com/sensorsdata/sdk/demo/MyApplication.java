...
public class MyApplication extends Application {
     ...
     */
    private final static String SA_SERVER_URL = AppConstant.serverUrl;
    ...
    private void initSensorsDataAPI() {
        ...
        configOptions
                .setProjectId("1044908514905948160")
                .setAutoTrackEventType(SensorsAnalyticsAutoTrackEventType.APP_START |
